...
export default function PricesModule({ onBack }: PricesModuleProps) {
    ...
    <div className="space-y-6 animate-fade-in text-left">
      ...
      <div className="clean-card p-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Real-time APMC wholesale rates, Government MSP margins and 7-day price trajectory</p>
          </div>
        </div>
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-32 text-slate-400 gap-3">
          ...
          <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Fetching live commodity ticker...</span>
        </div>
      ) : error ? (
        <div className="clean-card p-6 bg-rose-50 border-rose-200 text-rose-800 text-xs flex items-center gap-2">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="clean-card p-6 md:p-8 space-y-5">
              <h3 className="text-xs font-bold text-slate-600 uppercase tracking-wider flex items-center gap-1.5">
                <MapPin className="h-4 w-4 text-emerald-600" /> Regional Mandi Rate Sheets
              </h3>
            ...
            <div className="clean-card p-6 md:p-8 space-y-6">
              <h3 className="text-xs font-bold text-slate-600 uppercase tracking-wider flex items-center gap-1.5">
                <Scale className="h-4 w-4 text-emerald-600" /> 7-Day Price Trend
              </h3>
